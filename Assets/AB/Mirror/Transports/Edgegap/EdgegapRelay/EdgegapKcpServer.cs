...
namespace Edgegap
{
    public class EdgegapKcpServer : KcpServer
    {
        ...
        public void Start(string relayAddress, ushort relayPort, uint userId, uint sessionId)
        {
            ...
            if (!kcp2k.Common.ResolveHostname(relayAddress, out IPAddress[] addresses))
            {
            ...
            kcp2k.Common.ConfigureSocketBuffers(relaySocket, config.RecvBufferSize, config.SendBufferSize);
